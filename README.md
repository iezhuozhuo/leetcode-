...
十叉树的生长过程，同层索引以及跨层索引。另外由于字典序的原因导致$$i*10 < i+1$$。

#### 练手题

[386 字典序排数](386.md), [440 字典序的第k小的数](440.md) 

### 组合类型题目

#### 思路

基本上就是回溯，选择放或者不放。另外判断放的条件根据不同的题目有变化。同时防止出现重复元素重复取或者出现重复的组合如([1,7]和[7,1])可以先排序。

另一种思路是转换成背包问题，尤其时求背包总数如39以及377

[77 组合](77.md) [39 组合总数](39.md) [40 组合总和II](40.md) [216 组合总和III](216.md) [377 组合总和IV](377.md) 
